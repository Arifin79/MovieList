...
import com.example.submission5.widget.FavoriteWidget;
...
import static com.example.submission5.db.DatabaseContract.MovieColumns.TITLE;
...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (jenisData.equals("movie")) {
            ...
            tvHelper = TvShowsHelper.getInstance(getApplicationContext());
            try {
                tvHelper.open();
            } catch (SQLException e) {
                e.printStackTrace();
...
//            }
    ...
    private void favoriteState() {
        ...
        if (jenisData.equals("movie")) {
            ...
            MoviesItem movieItem = movieHelper.getMovieById(id);

            if (movieItem != null) {
                Log.d("detail", "favoriteState: data favorite ditemukan");
                Log.d("detail", "favoriteState: " + movieItem);

                List<MoviesItem> movieItemList = new ArrayList<>();
