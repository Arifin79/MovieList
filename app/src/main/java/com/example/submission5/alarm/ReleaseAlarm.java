package com.example.submission5.alarm;
...
import com.example.submission5.activity.MainActivity;
...
public class ReleaseAlarm  extends BroadcastReceiver {
    ...
    private List<MoviesItem> listMovies = new ArrayList<>();
...
//                        showNotification(context, listMovies.get(i), idNotif);
    ...
    private class generatePictureStyleNotification extends AsyncTask<String, Void, Bitmap> {
        ...
        private MoviesItem movieItem;
        private int notifId;

        generatePictureStyleNotification(Context context, MoviesItem movieItem, int idNotif) {
            super();
