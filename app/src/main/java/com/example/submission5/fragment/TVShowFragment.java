...
import com.example.submission5.adapter.TvShowsAdapter;
...
public class TVShowFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tvAdapter = new TvShowsAdapter(getActivity());
    ...
    private void showRecyclerList() {
        ...
        tvAdapter.setOnItemClickCallback(new TvShowsAdapter.OnItemClickCallback() {
            @Override
